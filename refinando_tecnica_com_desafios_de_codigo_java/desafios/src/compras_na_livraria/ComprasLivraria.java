...
public class ComprasLivraria {
    ...
    public static void main(String[] args) {
        ...
        Integer totalLivrosComprados = livro1.quantidade + livro2.quantidade;
        ...
        System.out.println("Numero de livros comprados: " + totalLivrosComprados);
